      ...
      <div className="w-full max-w-md relative animate-in fade-in zoom-in-95 duration-700">
        ...
        <div className="text-center mb-10">
          ...
          <div className="flex items-center justify-center gap-4 opacity-40">
            ...
            <span className="text-history-bronze italic text-xs uppercase tracking-widest text-nowrap">Новая летопись</span>
            <div className="h-px w-8 bg-history-bronze"></div>
          </div>
        </div>

        <div className="bg-black/10 backdrop-blur-sm p-1 rounded-xl shadow-2xl">
          <RegisterForm />
        </div>
        
        <p className="mt-12 text-center text-history-bronze/30 text-[9px] tracking-[0.4em] uppercase font-sans">
          Inscritio In Systema &bull; 2026
        </p>
      </div>
    </div>
  );
